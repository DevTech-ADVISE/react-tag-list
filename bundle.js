		...
		render: function() {
			...
			return (
				React.createElement("div", null, 
					React.createElement(ReactTagList, {values: tags, onRemove: this.removeTag, collapsedRows: 1}), 
	...
	module.exports = React.createClass({displayName: "exports",
	  ...
	  render: function() {
	    ...
	    tags = this.props.values.map(function(value, vIndex) {
	      return (
	        React.createElement("li", {ref: "tag-" + vIndex, key: "tag-" + vIndex, className: "rtl-tag"}, 
	          React.createElement("div", {className: "rtl-label"}, value.label), 
	          React.createElement("button", {ref: "tag-" + vIndex + "-remove", className: "rtl-remove-button", name: "clear", value: value.label, onClick: this.onRemoveFunc().bind(null, value.value)}, "X")
	        )
	      );
	    }.bind(this));
	    ...
	    if(this.state.showExpandButton) {
	      expandButton = (
	        React.createElement("div", {className: "expand-control-show"}, 
	          React.createElement("div", {className: "expand-button", onClick: this.toggleExpand}, expandText), 
	          React.createElement("div", {className: "show-count"}, countText)
	        )
	      );
	    }
	    else {
	      expandButton = (
	        React.createElement("div", {className: "expand-control-hide"}, 
	          React.createElement("div", {className: "expand-button", onClick: this.toggleExpand}, expandText), 
	          React.createElement("div", {className: "show-count"}, countText)
	        ));
	    }
	    ...
	    return (      
	      React.createElement("ul", {ref: "rtl-container", className: "react-tag-list"}, 
	        React.createElement("div", {ref: "rtl-tags", className: "rtl-tags" + " " + collapsedStyleName, style: rtlStyles}, tags), 
	        expandButton
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLegacyElement = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(48);
	var ReactStateSetters = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var ReactTransitionChildMapping = __webpack_require__(51);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(28);
	var ReactPropTransferer = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDefaultPerfAnalysis = __webpack_require__(61);
	var ReactMount = __webpack_require__(35);
	var ReactPerf = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var keyMirror = __webpack_require__(72);
	var keyOf = __webpack_require__(53);
	var monitorCodeUse = __webpack_require__(78);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(60);
	var DOMPropertyOperations = __webpack_require__(21);
	var ReactBrowserComponentMixin = __webpack_require__(82);
	var ReactComponent = __webpack_require__(24);
	var ReactBrowserEventEmitter = __webpack_require__(66);
	var ReactMount = __webpack_require__(35);
	var ReactMultiChild = __webpack_require__(36);
	...
	function inject() {
	  ...
	  if ("production" !== process.env.NODE_ENV) {
	    ...
	    if ((/[?&]react_perf\b/).test(url)) {
	      var ReactDefaultPerf = __webpack_require__(19);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CSSCore = __webpack_require__(115);
	var ReactTransitionEvents = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var emptyFunction = __webpack_require__(52);
	var invariant = __webpack_require__(56);
	var joinClasses = __webpack_require__(117);
	var warning = __webpack_require__(55);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createArrayFrom = __webpack_require__(169);
	var getMarkupWrap = __webpack_require__(168);
	var invariant = __webpack_require__(56);
