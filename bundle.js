...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactTagList = __webpack_require__(1);
	
	var DemoTagList = React.createClass({displayName: "DemoTagList",
		...
		render: function() {
			...
			return (
				React.createElement("div", null, 
					React.createElement(ReactTagList, {values: tags, onRemove: this.removeTag, removeAll: this.removeAllTags, collapsedRows: 1}), 
					React.createElement("div", {className: "input-tags"}, 
						React.createElement("input", {type: "text", 
							   onChange: this.handleInputChange, 
						       placeholder: "Type new tag...", 
						   	   value: tagInput}), 
						React.createElement("button", {onClick: this.addTag.bind(this, {label: tagInput, value: addValue})}, "Add Tag")
					)
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var elementSize = __webpack_require__(4);
	  ...
	  render: function() {
	    ...
	    tags = this.props.values.map(function(value, vIndex) {
	      if(this.props.easyClick) {
	        return (
	          React.createElement("li", {ref: "tag-" + vIndex, key: "tag-" + vIndex, className: "rtl-tag easy-click"}, 
	            React.createElement("button", {ref: "tag-" + vIndex + "-remove", className: "rtl-tag-button", name: "clear", value: value.label, onClick: this.onRemoveFunc().bind(null, value.value)}, 
	              React.createElement("span", {className: "rtl-label strike-label"}, value.label), 
	              React.createElement("span", {className: "rtl-remove-button"}, "×")
	            )
	          )
	        );
	      }
	        ...
	        return (
	          React.createElement("li", {ref: "tag-" + vIndex, key: "tag-" + vIndex, className: "rtl-tag"}, 
	            React.createElement("span", {className: "rtl-label"}, value.label), 
	            React.createElement("button", {ref: "tag-" + vIndex + "-remove", className: "rtl-remove-button", name: "clear", value: value.label, onClick: this.onRemoveFunc().bind(null, value.value)}, "×")
	          )
	        );
	      }
	    ...
	    if(tags.length === 0) {
	      tags = (React.createElement("li", {className: "rtl-placeholder"}, this.props.placeholderText))
	    }
	    ...
	    if(this.state.showExpandButton) {
	      ...
	      expandButton = (
	        React.createElement("li", {className: "expand-control expand-control-show"}, 
	          React.createElement("button", {onClick: this.toggleExpand, className: "expand-button", title: showMoreTitle}, 
	            React.createElement("span", {className: "show-count"}, countText), 
	            React.createElement("span", {className: "expand-text"}, expandText)
	          )
	        )
	      );
	    } else {
	      expandButton = (
	        React.createElement("li", {className: "expand-control expand-control-hide"}
	        ));
	    }
	
	    clearAllButton = React.createElement("li", {className: clearAllClass}, React.createElement("button", {title: "Clear All", onClick: this.removeAllTags}, "×"))
	    ...
	    return (      
	      React.createElement("div", {ref: "rtl-container", className: parentClassName}, 
	        React.createElement("ul", {ref: "rtl-tags", className: "rtl-tags" + " " + collapsedStyleName, style: rtlStyles}, 
	          tags, 
	          clearAllButton, 
	          expandButton
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		module.hot.accept("!!/Users/andrewblowe/Projects/usaid/react-tag-list/node_modules/css-loader/index.js!/Users/andrewblowe/Projects/usaid/react-tag-list/node_modules/sass-loader/index.js!/Users/andrewblowe/Projects/usaid/react-tag-list/lib/react-tag-list.scss", function() {
			var newContent = require("!!/Users/andrewblowe/Projects/usaid/react-tag-list/node_modules/css-loader/index.js!/Users/andrewblowe/Projects/usaid/react-tag-list/node_modules/sass-loader/index.js!/Users/andrewblowe/Projects/usaid/react-tag-list/lib/react-tag-list.scss");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ".font, .react-tag-list .rtl-tag {\n  font-family: Arial, Helvetica, sans-serif;\n  font-size: .9em; }\n\n.user-select-none, .react-tag-list, .react-tag-list .expand-control .expand-button {\n  -webkit-user-select: none;\n  /* Chrome all / Safari all */\n  -moz-user-select: none;\n  /* Firefox all */\n  -ms-user-select: none;\n  /* IE 10+ */\n  /* No support for these yet, use at own risk */\n  -o-user-select: none;\n  user-select: none; }\n\n.user-select-all, .react-tag-list .rtl-label {\n  -webkit-user-select: all;\n  /* Chrome all / Safari all */\n  -moz-user-select: all;\n  /* Firefox all */\n  -ms-user-select: all;\n  /* IE 10+ */\n  /* No support for these yet, use at own risk */\n  -o-user-select: all;\n  user-select: all; }\n\n.react-tag-list {\n  position: relative;\n  padding-left: .6em;\n  padding-right: 4em; }\n  .react-tag-list .rtl-tags {\n    list-style-type: none;\n    overflow: hidden;\n    padding: .6em 0 0 .4em;\n    margin: 6px 0;\n    box-sizing: content-box;\n    box-shadow: inset 0 0 2px 0 rgba(200, 200, 200, 0);\n    min-height: 2.3em; }\n    .react-tag-list .rtl-tags.rtl-expanded {\n      overflow: auto;\n      max-height: 300px !important;\n      box-shadow: inset 0 0 2px 0 rgba(200, 200, 200, 0.9); }\n  .react-tag-list .rtl-tag {\n    list-style-type: none;\n    display: inline-block;\n    border: 1px solid #d0d0d0;\n    border-radius: 3px;\n    background: #fff;\n    padding: 0 1.4em 0 0;\n    margin: 0 .8em .6em 0;\n    font-size: 1em;\n    box-sizing: border-box; }\n    .react-tag-list .rtl-tag.easy-click {\n      border: 0;\n      padding: 0; }\n      .react-tag-list .rtl-tag.easy-click .rtl-tag-button {\n        background: #fff;\n        border: 1px solid #d0d0d0;\n        padding: 0 1.4em 0 0;\n        position: relative;\n        font-size: 1em;\n        border-radius: 3px;\n        cursor: pointer; }\n        .react-tag-list .rtl-tag.easy-click .rtl-tag-button .rtl-remove-button {\n          line-height: 1;\n          width: 1.1em; }\n        .react-tag-list .rtl-tag.easy-click .rtl-tag-button:hover, .react-tag-list .rtl-tag.easy-click .rtl-tag-button:focus {\n          background: #fff;\n          border: 1px solid #d0d0d0; }\n          .react-tag-list .rtl-tag.easy-click .rtl-tag-button:hover .strike-label, .react-tag-list .rtl-tag.easy-click .rtl-tag-button:focus .strike-label {\n            text-decoration: line-through; }\n          .react-tag-list .rtl-tag.easy-click .rtl-tag-button:hover .rtl-remove-button, .react-tag-list .rtl-tag.easy-click .rtl-tag-button:focus .rtl-remove-button {\n            background-color: rgba(120, 120, 120, 0.2);\n            box-shadow: inset 2px 0 0 0 white; }\n  .react-tag-list .rtl-label {\n    display: inline-block;\n    line-height: 1.6em;\n    padding: 0 0 0 .5em;\n    position: relative;\n    z-index: 1; }\n  .react-tag-list .rtl-remove-button {\n    background-color: transparent;\n    color: #e45050;\n    border: 0;\n    border-radius: 0 3px 3px 0;\n    text-decoration: none;\n    line-height: 0;\n    font-weight: bold;\n    text-transform: uppercase;\n    position: absolute;\n    z-index: 0;\n    top: 0;\n    right: 0;\n    padding: 0;\n    height: 100%;\n    width: 1.2em;\n    cursor: pointer;\n    font-size: 1.2em; }\n    .react-tag-list .rtl-remove-button:hover {\n      background-color: rgba(120, 120, 120, 0.2);\n      box-shadow: inset 2px 0 0 0 white; }\n  .react-tag-list .rtl-placeholder {\n    font-family: '.HelveticaNeueDeskInterface-Regular';\n    font-size: 1em;\n    margin-left: .5em;\n    padding-left: 1px;\n    /* needed to match the border-width placement of an item */\n    margin-top: .3em;\n    font-style: italic;\n    color: #999; }\n  .react-tag-list .clear-all-control {\n    position: absolute;\n    top: .6em;\n    right: 2.8em;\n    transition: right 32ms ease-in; }\n    .react-tag-list .clear-all-control.hide-clear-button {\n      display: none; }\n    .react-tag-list .clear-all-control button {\n      font-size: 1.2em;\n      font-weight: bold;\n      line-height: .9em;\n      background-color: #f7f7f7;\n      border-radius: .8em;\n      border: 1px solid #ccc;\n      cursor: pointer;\n      color: #e45050;\n      position: relative;\n      padding: .1em .4em .4em;\n      text-align: center;\n      box-shadow: inset 2px 2px 2px 0px rgba(255, 255, 255, 0.7), inset -1px -1px 1px 0 rgba(60, 60, 60, 0.1);\n      transition: all 200ms ease-out; }\n      .react-tag-list .clear-all-control button:hover {\n        border-color: #c9c9c9;\n        box-shadow: inset 1px 1px 1px 0px rgba(255, 255, 255, 0.7), inset 0 0 1px 0 rgba(0, 0, 0, 0.1); }\n      .react-tag-list .clear-all-control button:active {\n        background-color: #fafafa;\n        border-color: #e45050;\n        box-shadow: inset 1px 1px 1px 0px rgba(255, 255, 255, 0.7), inset 0 0 1px 0 rgba(0, 0, 0, 0.1); }\n  .react-tag-list .expand-control {\n    position: absolute;\n    padding: 0;\n    top: .6em;\n    bottom: auto;\n    right: .2em;\n    z-index: 1;\n    transition: all 300ms ease-in-out; }\n    .react-tag-list .expand-control.expand-control-show {\n      display: block; }\n    .react-tag-list .expand-control.expand-control-hide {\n      display: none; }\n    .react-tag-list .expand-control .expand-button {\n      height: 1.8em;\n      width: 2em;\n      font-size: 1em;\n      line-height: .9em;\n      letter-spacing: -.02em;\n      background-color: #eee;\n      border-radius: 4px;\n      border: 1px solid #ccc;\n      cursor: pointer;\n      color: #555;\n      position: relative;\n      padding: .1em .3em .5em;\n      text-align: center;\n      box-shadow: inset 2px 2px 2px 0px rgba(255, 255, 255, 0.7), inset -1px -1px 1px 0 rgba(0, 0, 0, 0.1);\n      transition: all 200ms ease-out; }\n      .react-tag-list .expand-control .expand-button:hover {\n        border-color: #c9c9c9;\n        box-shadow: inset 1px 1px 1px 0px rgba(255, 255, 255, 0.7), inset 0 0 1px 0 rgba(0, 0, 0, 0.1); }\n      .react-tag-list .expand-control .expand-button:active {\n        background-color: #fafafa;\n        border-color: #bbb;\n        box-shadow: inset 1px 1px 1px 0px rgba(255, 255, 255, 0.7), inset 0 0 1px 0 rgba(0, 0, 0, 0.1);\n        color: #2d8bee; }\n      .react-tag-list .expand-control .expand-button .show-count {\n        font-size: 12px;\n        position: absolute;\n        width: 100%;\n        letter-spacing: -.1em;\n        white-space: nowrap;\n        display: inline-block;\n        margin-top: -1em;\n        top: 1em;\n        left: 0; }\n      .react-tag-list .expand-control .expand-button .expand-text {\n        font-size: 20px; }\n  .react-tag-list.parent-expand {\n    padding-right: 3em; }\n    .react-tag-list.parent-expand .rtl-tags.rtl-expanded:hover {\n      box-shadow: inset 0 0 2px 1px rgba(200, 200, 200, 0.9); }\n    .react-tag-list.parent-expand .clear-all-control {\n      right: .7em;\n      transition: all 247ms ease-out; }\n    .react-tag-list.parent-expand .expand-control {\n      top: auto;\n      bottom: .3em; }\n      .react-tag-list.parent-expand .expand-control .expand-button {\n        padding: .35em .4em .15em;\n        border-radius: .2em; }\n  .react-tag-list.parent-collapse ul:after {\n    background-color: transparent; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLifeCycle = __webpack_require__(53);
	...
	var assign = __webpack_require__(28);
	var invariant = __webpack_require__(46);
	var keyMirror = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ClientReactRootIndex = __webpack_require__(68);
	...
	var MobileSafariClickEventPlugin = __webpack_require__(72);
	var ReactBrowserComponentMixin = __webpack_require__(73);
	var ReactClass = __webpack_require__(14);
	var ReactComponentBrowserEnvironment =
	  __webpack_require__(63);
	var ReactDefaultBatchingStrategy = __webpack_require__(74);
	var ReactDOMComponent = __webpack_require__(64);
	var ReactDOMButton = __webpack_require__(75);
	var ReactDOMForm = __webpack_require__(76);
	var ReactDOMImg = __webpack_require__(77);
	var ReactDOMIDOperations = __webpack_require__(78);
	var ReactDOMIframe = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactLink = __webpack_require__(107);
	var ReactStateSetters = __webpack_require__(108);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(8);
	var ReactTransitionChildMapping = __webpack_require__(110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(45);
	var EventPluginHub = __webpack_require__(116);
	var EventPluginRegistry = __webpack_require__(148);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createNodesFromMarkup = __webpack_require__(177);
	var emptyFunction = __webpack_require__(102);
